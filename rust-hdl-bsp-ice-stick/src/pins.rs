...
/// Provides the clock pin as an abstracted Signal
pub fn hx1ktq144_clock() -> Signal<In, Clock> {
...
/// Provides the LED pins as abstracted Signals
pub fn hx1ktq144_leds() -> Signal<Out, Bits<5>> {
