...
pub fn simulate() {
    ...
    let mut simulation: Simulation<BitAdder<N>> = simple_sim!(BitAdder<N>, clock, 100_000_000, ep, {
    ...
    simulation.run(BitAdder::default().into(), sim_time::ONE_MILLISECOND).unwrap();
}
